...
do{System.out.println("Please enter the service you want to book Hotel Stay/ Cruise");
String UserSelected= sc.nextLine().toLowerCase();
switch(UserSelected) {
case "hotel": 
	do{System.out.println("Please enter the room you want to select\r\n"
...
case "cruise":
	do {
		...
		while (!cruiseSelec.equals("scenic cruise") && !cruiseSelec.equals("sunset cruise")&& !cruiseSelec.equals("discovery cruise")&& !cruiseSelec.equals("mystery cruise"));
